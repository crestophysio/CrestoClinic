...
import { Plus, Minus, HelpCircle, ShieldCheck, CheckCircle, ArrowUpRight } from "lucide-react";
...
export default function FAQList({ faqs, lang }: FAQListProps) {
  ...
  const checklistItems = [
    "Track & improve your mobility",
    "Schedule physiotherapy sessions",
    "Expert musculoskeletal treatment",
    "Get personalised rehab plans",
  ];
                ...
                <div className="space-y-4 w-full">
                  ...
                  {hasMore && (
                    <div className="flex justify-center pt-4">
                      ...
                      >
                        <span>{lang === "en" ? "See All FAQs" : "அனைத்து கேள்விகளும்"}</span>
