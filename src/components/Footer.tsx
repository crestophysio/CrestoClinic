    ...
    <footer className="bg-teal text-white pt-16 pb-8 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Logo & Description */}
          <div>
            <h3 className="font-heading font-bold text-2xl text-white mb-4 tracking-tight">
              {clinicName}
            </h3>
            <p className="text-gray-400 text-sm leading-relaxed mb-6">
              {settings?.tagline ||
                "Expert physiotherapy, manual therapy, neurological rehabilitation, and sports injury care in Bengaluru."}
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <Link href="#home" className="text-gray-300 hover:text-pink text-sm transition-colors">
                {lang === "en" ? "Home" : "முகப்பு"}
              </Link>
              <Link href="#about" className="text-gray-300 hover:text-pink text-sm transition-colors">
                {lang === "en" ? "About Us" : "எங்களைப் பற்றி"}
              </Link>
              <Link href="#doctors" className="text-gray-300 hover:text-pink text-sm transition-colors">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm text-gray-400">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={`tel:${settings?.phone}`} className="hover:text-pink transition-colors">
        ...
        <div className="mt-4 text-center text-xs text-gray-500">
          <p>
            ...
            <a
              ...
              className="font-semibold text-pink hover:text-white transition-colors"
            >
              Senthil
            </a>{" "}
            &amp;{" "}
