    ...
    <>
      ...
      <header className="lg:hidden w-full bg-slate-900 text-white p-4 flex items-center justify-between border-b border-slate-800 sticky top-0 z-30">
        <div className="flex items-center gap-2">
          ...
          <span className="font-heading font-bold text-base text-white">Cresto Admin</span>
        </div>
      ...
      >
        <div>
          ...
          <div className="p-6 border-b border-slate-800 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Stethoscope className="w-6 h-6 text-teal-400" />
              <span className="font-heading font-bold text-lg text-white">Cresto Admin</span>
            </div>
            <button
              onClick={() => setIsOpen(false)}
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950/20">
          <div className="flex items-center justify-between mb-4">
            <div className="text-xs">
              <p className="font-bold text-white">Cresto Admin</p>
              <p className="text-slate-500">Administrator</p>
            </div>
            <Link
              href="/"
              className="text-xs text-teal hover:text-teal-light font-bold underline"
            >
              View Site
            </Link>
          </div>
