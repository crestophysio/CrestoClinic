          ...
          >
            <div className="bg-gradient-to-br from-brand-blush/60 via-white to-teal-tint/25 border border-brand-border p-8 sm:p-10 rounded-3xl flex-1 flex flex-col justify-between shadow-sm relative overflow-hidden">
              ...
              <div className="relative space-y-8">
                {/* Header */}
                <div>
                  <h3 className="font-heading font-bold text-xl text-brand-ink mb-1.5">Cresto Physiotherapy Clinic</h3>
                  <p className="text-xs text-brand-muted">Get in touch directly or visit our physiotherapy centre.</p>
                </div>
