        ...
        <div className="flex gap-8 whitespace-nowrap animate-marquee-reverse">
          {[...Array(4)].map((_, idx) => (
            <div key={idx} className="flex gap-8 text-[10px] font-bold text-pink-safe uppercase tracking-widest">
              ...
              <span>✦ Advanced Rehab Equipment</span>
              <span>✦ Personalised Recovery Plans</span>
            </div>
          ))}
        </div>
      </div>
          ...
          >
            <div className="space-y-6 flex flex-col justify-between">
              ...
              >
                ...
                <p className="font-heading font-semibold text-lg text-brand-ink mb-2">{a("aboutMission")}</p>
              ...
              >
                ...
                <p className="font-heading font-semibold text-lg text-brand-ink mb-2">{a("aboutVision")}</p>
            ...
            <div className="flex items-stretch h-full">
              ...
              >
                ...
                <p className="font-heading font-semibold text-lg text-brand-ink mb-2">{a("aboutPremium")}</p>
