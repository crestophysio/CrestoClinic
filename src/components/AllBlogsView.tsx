        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-brand-border/60 pb-8">
          <div>
            ...
            <h1 className="font-heading font-bold text-3xl sm:text-4xl text-brand-ink">
              Cresto Physiotherapy — Health Tips & Blogs
            </h1>
            <p className="text-brand-muted text-sm mt-2">
              Expert physiotherapy advice and rehabilitation guides from our specialist team.
            </p>
          </div>
              ...
              <div>
                ...
                <div className="relative w-full aspect-video bg-teal-tint/30">
                  {post.image ? (
                    ...
                    <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-teal-tint to-teal-tint/60 gap-2">
                      <div className="w-12 h-12 rounded-full bg-teal/10 flex items-center justify-center border border-teal/20">
                        <span className="text-teal font-heading font-bold text-lg">C</span>
                      </div>
                      <span className="text-teal/50 font-heading font-semibold text-xs">Cresto Physiotherapy</span>
                    </div>
                  )}
